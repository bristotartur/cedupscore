...
public class EventService {
    ...
    public Page<Event> findAllEvents(EventType type, Pageable pageable) {
        ...
        event.getScores().forEach(score -> {
            ...
            edition.getTeamScores().stream()
                    ...
                    .ifPresent(teamScore -> {
                        ...
                        if (type.equals(EventType.TASK)) teamScore.setTasksWon(teamScore.getTasksWon() + 1);
                        if (type.equals(EventType.SPORT)) teamScore.setSportsWon(teamScore.getSportsWon() + 1);
                    });
        });
    }
